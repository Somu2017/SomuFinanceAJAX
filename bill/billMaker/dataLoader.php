<?php
	...
	if(!empty($_GET)&&$_GET['action']=="getBill"&&!empty($_SESSION['billDate']))
	{
		$billDate = $_SESSION['billDate'];
		$datePHP = date("My",strtotime($billDate));
		$billIndexTableName = "MonthlyBillIndex_".$datePHP;
	...
	if(!empty($_POST)&&($_POST['action']=='editExternal'))
	{
		$billDate = $_SESSION['billDate'];
		$datePHP = date("My",strtotime($billDate));
		$billsTableName = "Bills_".$datePHP;
	...
	if(!empty($_POST)&&($_POST['action']=='submitEdit')&&!empty($_SESSION['billDate']))
	{
		$id = $_POST['id'];
		$mrp = $_POST['mrp'];
	...
	if(!empty($_GET)&&$_GET['action']=="getPaid"&&!empty($_SESSION['billDate']))
	{
		$billDate = $_SESSION['billDate'];
	...
	if(!empty($_POST)&&($_POST['action']=='submitBillAmount')&&!empty($_SESSION['billDate']))
	{
